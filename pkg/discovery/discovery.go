...
// setMulticastSocketOptions sets socket options for multicast on the transmitting UDP socket.
func setMulticastSocketOptions(conn *net.UDPConn, ip net.IP) error {
	...
	err = rawConn.Control(func(fd uintptr) {
		...
		// If 0.0.0.0 (IPv4zero), skip IP_MULTICAST_IF and only configure loopback
